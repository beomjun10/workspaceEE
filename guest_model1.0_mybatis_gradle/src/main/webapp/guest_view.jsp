...
if (guest == null) {
	...
	out.println("	location.href='guest_main.jsp';");
	out.println("</script>");
	return;
}
%>	
							...
							<form name="f" method="post">
								...
								<table border="0" cellpadding="0" cellspacing="1" width="590"
									...
									<tr>
										...
										<td width=490 bgcolor="ffffff" align="left"
											style="padding-left: 10px"><%=new SimpleDateFormat("yyyy-MM-dd").format(guest.getGuest_date())%></td>
									<tr>
...
<p align="center">Copyright (&copy;) By Class5.[class5] All rights
	reserved.</p>	
